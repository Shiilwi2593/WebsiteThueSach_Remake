...
use App\Design_patterns\Strategy\Product\DestroyProduct;
use App\Design_patterns\Strategy\Product\UpdateProduct;
...
class ProductsController extends Controller
{
    ...
    public function update(Request $request, Product $product, IUpdateStrategy $updateStrategy)
    {
        $check = $updateStrategy->update($request, $product);

        $msg = $check 
            ? '<div class="alert alert-success alert-dismissible">Product updated successfully</div>'
            : '<div class="alert alert-danger alert-dismissible">Product updated failed</div>';

        return redirect()->route('admin.products.index')->with('message', $msg);
    }
    
    public function destroy(Product $product, IDestroyStrategy $destroyStrategy)
    {
        $check = $destroyStrategy->destroy($product);

        $msg = $check 
            ? '<div class="alert alert-success alert-dismissible">Product delete successfully</div>'
            : '<div class="alert alert-danger alert-dismissible">Product delete failed</div>';
