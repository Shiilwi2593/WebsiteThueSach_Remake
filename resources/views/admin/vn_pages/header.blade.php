                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                ...
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ Auth::user()->userInfo->first_name }} {{Auth::user()->userInfo->last_name}}</span>
                                <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">Chào mừng</span>
                            </span>
                        </span>
                    </button>
