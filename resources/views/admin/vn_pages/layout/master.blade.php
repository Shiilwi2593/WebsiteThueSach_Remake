                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                            ...
                            <button type="button" class="btn w-sm btn-danger" id="delete-notification">Có, xóa nó đi!</button>
                        </div>
                    </div>
    ...
    <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-settings-offcanvas">
        ...
        <div class="offcanvas-body p-0">
            <div data-simplebar class="h-100">
                <div class="p-4">
                    <h6 class="mb-0 fw-semibold text-uppercase">BỐ CỤC</h6>
                    ...
                    <div class="row gy-3">
                        <div class="col-4">
                            ...
                            <h5 class="fs-13 text-center mt-2">THẲNG</h5>
                        </div>
                        <div class="col-4">
                            <div class="form-check card-radio">
                        ...
                        <div class="col-4">
                            ...
                            <h5 class="fs-13 text-center mt-2">HỘP</h5>
                        </div>
                        <!-- end col -->
                    </div>

                    <h6 class="mt-4 mb-0 fw-semibold text-uppercase">CHẾ ĐỘ MÀU</h6>
                    ...
                    <div id="sidebar-visibility">
                        ...
                        <p class="text-muted">CHỌN HIỂN THỊ HOẶC TẮT THANH BÊN</p>
                    ...
                    <div id="layout-width">
                        <h6 class="mt-4 mb-0 fw-semibold text-uppercase">CHIỀU RỘNG BỐ CỤC</h6>
                        <p class="text-muted">CHỌN BỐ CỤC LINH HOẠT HOẶC KHÓA</p>
                        ...
                        <div class="row">
                            <div class="col-4">
                                ...
                                <h5 class="fs-13 text-center mt-2">Linh hoạt</h5>
                            </div>
                            <div class="col-4">
                                <div class="form-check card-radio">
                                    <input class="form-check-input" type="radio" name="data-layout-width"
                                ...
                                <h5 class="fs-13 text-center mt-2">Khóa</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="layout-position">
                        ...
                        <p class="text-muted">CHỌN VỊ TRÍ BỐ CỤC CỐ ĐỊNH HOẶC CÓ THỂ CUỘN</p>
                    ...
                    <h6 class="mt-4 mb-0 fw-semibold text-uppercase">MÀU XẮC THANH CÔNG CỤ</h6>
                    <p class="text-muted">CHỌN CHẾ ĐỘ SÁNG HOẶC TỐI</p>
                    ...
                    <div id="sidebar-size">
                        <h6 class="mt-4 mb-0 fw-semibold text-uppercase">KÍCH CỠ THANH BÊN</h6>
                        <p class="text-muted">CHỌN KÍCH CỠ THANH BÊN</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <h5 class="fs-13 text-center mt-2">Gọn nhẹ</h5>
                            </div>
                            ...
                            <div class="col-4">
                                ...
                                <h5 class="fs-13 text-center mt-2">Nhỏ (Hiển thị icon)</h5>
                            </div>
                            ...
                            <div class="col-4">
                                ...
                                <h5 class="fs-13 text-center mt-2">Chế độ xem di chuột nhỏ</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="sidebar-view">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <h5 class="fs-13 text-center mt-2">Tách ra</h5>
                            </div>
                        </div>
                    </div>
                    <div id="sidebar-color">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <h5 class="fs-13 text-center mt-2">Hòa trộn</h5>
                            </div>
                        </div>
                        <!-- end row -->
                    ...
                    <div id="sidebar-img">
                        <h6 class="mt-4 mb-0 fw-semibold text-uppercase">HIỆU ỨNG HÌNH ẢNH</h6>
                        <p class="text-muted">Chọn ảnh cho thanh bên</p>
                    ...
                    <div id="preloader-menu">
                        <h6 class="mt-4 mb-0 fw-semibold text-uppercase">TRÌNH TẢI TRƯỚC</h6>
                        ...
                        <div class="row">
                            <div class="col-4">
                                ...
                                <h5 class="fs-13 text-center mt-2">Sử dụng</h5>
                            </div>
                            <div class="col-4">
                                <div class="form-check sidebar-setting card-radio">
                                    <input class="form-check-input" type="radio" name="data-preloader"
        ...
        <div class="offcanvas-footer border-top p-3 text-center">
            <div class="row">
                <div class="col-6">
                    <button type="button" class="btn btn-light w-100" id="reset-layout">CÀI LẠI MẶC ĐỊNH</button>
                </div>
            </div>
        </div>
    </div>
