                                    ...
                                    <tbody>
                                        @foreach($products as $product)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('admin.vnShow', ['product' => $product->id])}}" type="button" class="btn btn-sm btn-light">Chi tiết</a>
                                                    <a href="{{route('admin.vnEdit', ['product' => $product->id])}}" type="button" class="btn btn-sm btn-secondary">Sửa</a>
