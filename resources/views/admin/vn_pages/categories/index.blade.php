                            ...
                            <div class="col-sm">
                                ...
                                <a href="{{route('admin.categories.create')}}" class="btn btn-primary">Thêm mới thể loại</a>
                                    ...
                                    <select id="sort-by" class="form-control mx-2" style="width: 120px">
                                        ...
                                        <option value="0" @if (!is_null(request()->sort_by) && request()->sort_by == 0) selected @endif>Mới nhất
                                        </option>
                                        <option value="1" @if (!is_null(request()->sort_by) && request()->sort_by == 1) selected @endif>Cũ Nhất
                                        </option>
                                    </select>
                                    ...
                                    <div class="search-box ms-2">
                                        <input type="text" class="form-control" id="search-input"
                                            placeholder="Tìm kiếm thể loại..." value="{{ request()->keyword }}">
